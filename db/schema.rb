...
ActiveRecord::Schema[7.0].define(version: 2023_04_29_185004) do
  ...
  create_table "client_patients", force: :cascade do |t|
    ...
    t.index ["team_id"], name: "index_client_patients_on_team_id"
  end
  ...
  add_foreign_key "client_patients", "teams"
